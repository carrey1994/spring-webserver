...
public class Coupon implements Serializable {
	...
	@NotNull private UUID couponCode;
	...
	public static Coupon cashCoupon(BigDecimal cashDiscount, String description, GcUser user, UUID couponCode) {
	...
	public static Coupon percentageCoupon(
			BigDecimal percentageDiscount, String description, GcUser user, UUID couponCode) {
